...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-11 items-center justify-center rounded-xl bg-forest-900/80 p-1 text-muted-foreground border border-forest-700/50',
      className
    )}
    {...props}
  />
